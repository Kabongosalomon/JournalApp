...
import com.salomon.tehilah.journalapp.domain.FirebaseHelper;
import com.salomon.tehilah.journalapp.lib.EventBus;
import com.salomon.tehilah.journalapp.lib.EventBusImpl;
import com.salomon.tehilah.journalapp.noteslist.entities.User;
...
public class LoginRepositoryImpl implements LoginRepository {
    ...
    private void registerNewUser() {
        ...
        if (email != null) {
            User currentUser = new User(email,  null);
